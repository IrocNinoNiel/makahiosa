          ...
          <div class="card-body">
            <div class="mb-3">
              ...
              <div class="input-container">
                <input type="Date" name="dateOfApplication" placeholder="Date of Activity Application" value="{{old('dateOfApplication')}}">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="mb-3">
              ...
              <div class="input-container">
                <input type="text" name="nameOfRepresentative" placeholder="Name of the Representative" value="{{old('nameOfRepresentative')}}">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="mb-3">
              ...
              <div class="input-container">
                <input type="text" name="titleOfTheEvent" placeholder="Title of the Event" value="{{old('titleOfTheEvent')}}">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="mb-3">
              ...
              <div class="input-container">
                <input type="text" name="typeOfTheEvent" placeholder="Type of Event" value="{{old('typeOfTheEvent')}}">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="mb-3">
              ...
              <div class="input-container">
                <input type="text" name="generalObjective" placeholder="General Objective" value="{{old('generalObjective')}}">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="mb-3">
              ...
              <div class="input-container">
                <input type="Date" name="dateOfEvent" placeholder="Date of Event" value="{{old('dateOfEvent')}}">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="mb-3">
              ...
              <div class="input-container">
                <input type="Date" name="endDateOfTheEvent" placeholder="End Date of Event" value="{{old('endDateOfTheEvent')}}">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="mb-3">
              ...
              <div class="input-container">
                <input type="number" name="hoursDuration" placeholder="Hours Duration" value="{{old('hoursDuration')}}">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="mb-3">
              ...
              <div class="input-container">
                <input type="time" name="startOfEvent" placeholder="Start" value="{{old('startOfEvent')}}">
              </div>
            </div>
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label fw-bold">End <span class="required-field"></span></label>
              <div class="input-container">
                <input type="time" name="endOfEvent" placeholder="End" value="{{old('endOfEvent')}}">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="mb-3">
              ...
              <div class="input-container">
                <input type="text" name="numOfParticipant" placeholder="Hours Duration" value="{{old('numOfParticipant')}}">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="mb-3">
              ...
              <div class="input-container">
                <input type="text" name="venueOfEvent" placeholder="Venue of Event" value="{{old('venueOfEvent')}}">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="mb-3">
              ...
              <div class="input-container">
                <input type="integer" name="amountAllocated" placeholder="Amount Allocated" value="{{old('amountAllocated')}}">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="mb-3">
              ...
              <div class="input-container">
                <input type="text" name="sourceOfFunds" placeholder="Source of Funds" value="{{old('sourceOfFunds')}}">
              </div>
            </div>
          </div>
        </div>
